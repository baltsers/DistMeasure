...
do  
  ...
  then 
	...
	sleep 2 	
	timeout $out2 ./client3DT2BrPre.sh /home/username/fuzz/Messages/Message$line.txt > timecostclient3DT2BrPre_$line.log
	sleep 12  
	#rm /home/username/thrift/test1/*.em
	mv /home/username/thrift/test1/branch*.*  /home/username/thrift/test1/clientlog/$line
