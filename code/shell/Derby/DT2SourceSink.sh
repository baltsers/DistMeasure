...
source ./de_global.sh
ROOT=/home/xqfu
MAINCP="$ROOT/DUA/bin:$ROOT/DistTaint.jar:$ROOT/libs/soot-trunk.jar"

SOOTCP=".:/usr/lib/jvm/java-8-openjdk-amd64/jre/lib/rt.jar:$subjectloc/bin:$ROOT/DistTaint.jar"
