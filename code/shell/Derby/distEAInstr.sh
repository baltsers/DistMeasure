...
source ./de_global.sh
MAINCP=".:$ROOT/DUA/bin:$ROOT/distEA10.jar:$ROOT/libs/soot-trunk.jar:"
...
SOOTCP=".:/usr/lib/jvm/java-8-openjdk-amd64/jre/lib/rt.jar:$subjectloc/java:$subjectloc/lib2:$ROOT/distEA10.jar"
