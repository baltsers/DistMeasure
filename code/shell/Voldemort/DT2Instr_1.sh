...
SOOTCP=".:/usr/lib/jvm/java-8-openjdk-amd64/jre/lib/rt.jar:$subjectloc/dist/classes:/home/xqfu/DistTaint/bin"


echo $SOOTCP
OUTDIR=$subjectloc/DT2Instrumented/classes
mkdir -p $OUTDIR
...
java -Xmx10g -ea -cp ${MAINCP} disttaint.dt2Inst \
	-w -cp ${SOOTCP} \
