...
MAINCP=".:/usr/lib/jvm/java-8-openjdk-amd64/jre/lib/rt.jar:$ROOT/DUA7.jar:$ROOT/DistODD.jar:$ROOT/libs/soot-trunk.jar:$INDIR:$subjectloc/dist/voldemort-contrib-1.10.26.jar"
