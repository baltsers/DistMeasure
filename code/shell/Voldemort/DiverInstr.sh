...
#MAINCP=".:/opt/jdk1.8.0_101/jre/lib/rt.jar:/home/xqfu/libs/soot-trunk8.jar:/home/xqfu/libs/DUA3.jar:/home/xqfu/libs/mcia8.jar:$/home/xqfu/voldemort/bin"
MAINCP=".:/home/xqfu/libs/soot-trunk.jar:/home/xqfu/libs/DUAForensics.jar:/home/xqfu/libs/distEADIVER.jar"
echo $MAINCP
...
#SOOTCP=".:/opt/jdk1.8.0_101/jre/lib/rt.jar:/home/xqfu/voldemort/bin:/home/xqfu/libs/soot-trunk8.jar:/home/xqfu/libs/DUA3.jar:/home/xqfu/libs/mcia8.jar"

SOOTCP=".:/opt/jdk1.8.0_101/jre/lib/rt.jar:/home/xqfu/voldemort/dist/classes:/home/xqfu/voldemort/dist/testclasses:/home/xqfu/libs/distEADIVER.jar"


echo $SOOTCP
OUTDIR=/home/xqfu/voldemort/DiverInstrumented
mkdir -p $OUTDIR
...
java -Xmx4600m -ea -cp ${MAINCP} Diver.DiverInst \
	...
	-f c -d "$OUTDIR" -brinstr:off -duainstr:off \
   	-duaverbose \
	-slicectxinsens \
	-process-dir /home/xqfu/voldemort/dist/classes \
	-process-dir /home/xqfu/voldemort/dist/testclasses \
	-wrapTryCatch \
        -intraCD \
        -interCD \
        -exInterCD \
