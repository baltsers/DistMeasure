...
MAINCP=".:/opt/jdk1.8.0_101/jre/lib/rt.jar:/opt/jdk1.8.0_101/lib/tools.jar:$ROOT/DistEA/DUAForensics.jar:$ROOT/distEADIVER/bin:$ROOT/libs/soot-trunk.jar:$INDIR"
