...
MAINCP=".:/usr/lib/jvm/java-8-openjdk-amd64/jre/lib/rt.jar:/home/username/DUA7.jar:/home/username/libs/soot-trunk.jar:$ROOT/DistODD.jar:$ROOT/banderaCommons.jar:$ROOT/banderaToolFramework.jar:$ROOT/commons-cli-1.3.1.jar:$ROOT/commons-io-1.4.jar:$ROOT/commons-logging-1.2.jar:$ROOT/commons-pool-1.2.jar:$ROOT/trove-2.1.0.jar:$ROOT/xmlenc-0.52.jar:$ROOT/jibx-run-1.1.3.jar:$INDIR:$subjectloc/conf:$subjectloc/dist/voldemort-contrib-1.10.26.jar"
for i in /home/username/libs/*.jar;
do
	MAINCP=$MAINCP:$i
done
#for file in /home/username/voldemort/dist/*.jar;
#do
#  MAINCP=$MAINCP:$file
#done

for file in /home/username/voldemort/lib/*.jar;
do
  MAINCP=$MAINCP:$file
done

for file in /home/username/voldemort/contrib/*/libs/*.jar;
do
  MAINCP=$MAINCP:$file
done
