...
INDIR=$subjectloc/DT2Instrumented/testclasses
...
MAINCP=".:/usr/lib/jvm/java-8-openjdk-amd64/jre/lib/rt.jar:$ROOT/libs/soot-trunk.jar:$ROOT/DUA/bin:$ROOT/DUAForensics-bins-code/InstrReporters:$ROOT/DUAForensics-bins-code/LocalsBox:$ROOT/DistTaint/bin:$INDIR:$subjectloc/DT2Instrumented/classes:$subjectloc/conf:$subjectloc/dist/voldemort-contrib-1.10.26.jar"
