...
#INDIR=$subjectloc/DT2BrPre/classes/:$subjectloc/DT2BrPre/testclasses
INDIR=$subjectloc/DT2BrPre

MAINCP=".:/usr/lib/jvm/jaa-8-openjdk-amd64/jre/lib/rt.jar:$ROOT/DUA7.jar:$ROOT/DistTaint.jar:$ROOT/libs/soot-trunk.jar:$INDIR"
...
MAINCP=$MAINCP:/home/username/voldemort/dist/resources
