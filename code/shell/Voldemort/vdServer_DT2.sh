...
MAINCP=".:/usr/lib/jvm/jaa-8-openjdk-amd64/jre/lib/rt.jar:$ROOT/DUA/bin:$ROOT/DistTaint/bin:$ROOT/libs/soot-trunk.jar:$INDIR:$subjectloc/dist/voldemort-contrib-1.10.26.jar"
