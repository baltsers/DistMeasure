...
MAINCP=".:$ROOT/DistEA/DUAForensics.jar:$ROOT/libs/DistEA6.jar:$ROOT/libs/soot-trunk.jar:$subjectloc/conf:$subjectloc/distEAInstrumented:$subjectloc/distEAoutdyn:$subjectloc/bin"
