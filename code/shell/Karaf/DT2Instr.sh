...
SOOTCP=".:/home/xqfu/karaf/lib4/bin:/home/xqfu/karaf/lib4/karaf:$ROOT/DistTaint3.jar"


echo $SOOTCP
OUTDIR=/home/xqfu/karaf/DT2Instrumented
rm -R $OUTDIR -f
mkdir -p $OUTDIR
...
java -Xmx100g -ea -cp ${MAINCP} disttaint.dt2Inst \
	...
	-process-dir /home/xqfu/karaf/lib4/bin \
	-process-dir /home/xqfu/karaf/lib4/karaf \
	-dumpJimple \
	-dumpFunctionList \
    -wrapTryCatch \
        -intraCD \
