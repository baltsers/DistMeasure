...
SOOTCP=".:/usr/lib/jvm/java-8-openjdk-amd64/jre/lib/rt.jar:$subjectloc/lib4/bin:$subjectloc/lib4/karaf:$subjectloc/lib4/endorsed:$ROOT/distEA8.jar"
...
java -Xmx4000m -ea -cp ${MAINCP} distEA.distEAInst \
	...
	-dumpFunctionList \
	-slicectxinsens \
	-process-dir $subjectloc/lib4/bin \
	-process-dir $subjectloc/lib4/karaf \
