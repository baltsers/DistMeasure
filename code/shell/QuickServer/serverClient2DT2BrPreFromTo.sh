...
do   
	...
	sleep 6 
    timeout $outs ./client2DT2BrPre.sh /home/username/fuzz/Messages/Message$i.txt > timecostclient2DT2BrPre_$i.log
	sleep 4 
    #rm /home/username/quickserver/test1/*.em
    mv /home/username/quickserver/test1/branches*.* /home/username/quickserver/test1/clientlog/$i
