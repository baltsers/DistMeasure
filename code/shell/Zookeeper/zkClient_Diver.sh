...
INDIR=$subjectloc/DiverInstrumentedBad4
#INDIR=$subjectloc/build.sv/classes/
#INDIR=$subjectloc/build/classes/
MAINCP=".:/usr/lib/jvm/java-8-openjdk-amd64/jre/lib/rt.jar:$ROOT/libs/soot-trunk.jar:$ROOT/DUAForensics.jar:$ROOT/distDIVER.jar:$INDIR"
