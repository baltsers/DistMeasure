...
#MAINCP=".:/usr/lib/jvm/java-8-openjdk-amd64/jre/lib/rt.jar:/home/username/libs/soot-trunk8.jar:/home/username/libs/DUA3.jar:/home/username/libs/mcia8.jar:$$subjectloc/dist/classes"
# MAINCP=".:/home/username/libs/soot-trunk.jar:/home/username/DUA/bin:/home/username/DistODD.jar"
MAINCP=".:$ROOT/DistODD.jar:$ROOT/banderaCommons.jar:$ROOT/banderaToolFramework.jar:$ROOT/commons-cli-1.3.1.jar:$ROOT/commons-io-1.4.jar:$ROOT/commons-lang-2.1.jar:$ROOT/commons-logging-1.2.jar:$ROOT/commons-pool-1.2.jar:$ROOT/trove-2.1.0.jar:$ROOT/xmlenc-0.52.jar:/home/username/DUA/bin:$ROOT/jibx-run-1.1.3.jar:$ROOT/libs/soot-trunk.jar"
echo $MAINCP
rm -R ODDSGInstr -f
mkdir -p ODDSGInstr
