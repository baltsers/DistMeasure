...
source ./zk_global.sh
ROOT="/home/xqfu"
MAINCP=".:/opt/jdk1.8.0_101/jre/lib/rt.jar:/opt/jdk1.8.0_101/lib/tools.jar:$ROOT/DistEA/DUAForensics.jar:$ROOT/DistEA/DistEA.jar::$ROOT/libs/soot-trunk4.jar:$subjectloc/bin"

SOOTCP=".:/opt/jdk1.8.0_101/jre/lib/rt.jar:$ROOT/DistEA/DistEA.jar:$subjectloc/bin:$subjectloc/build/classes:$subjectloc/build/test/classes:$subjectloc/contrib/fatjar/classes:$subjectloc/lib/netty-3.7.0.Final.jar:$ROOT/DistEA/DistEA.jar:$ROOT/DistEA/DUAForensics.jar:$ROOT/libs/polyglotclasses-1.3.5.jar:$ROOT/libs/jasminclasses-2.5.0.jar:$ROOT/libs/heros-1.0.0-SNAPSHOT.jar:$ROOT/libs/soot-trunk4.jar:$subjectloc/bin"
...
java -Xmx10g -ea -cp ${MAINCP} distEA.distEAInst \
	...
	-dumpFunctionList \
	-slicectxinsens \
        -exclude org.apache.zookeeper.server \
