...
SOOTCP=".:/usr/lib/jvm/java-8-openjdk-amd64/jre/lib/rt.jar:$subjectloc/build4/test/classes:/home/xqfu/DistTaint/bin"


echo $SOOTCP
OUTDIR=$subjectloc/DT2Instr4
rm -R $OUTDIR -f
mkdir -p $OUTDIR
...
java -Xmx100g -ea -cp ${MAINCP} disttaint.dt2Inst \
	...
	-process-dir $subjectloc/build4/test/classes \
	-allowphantom \
	-wrapTryCatch \
    -intraCD \
    -interCD \
    -exInterCD \
#	-main-class org.apache.zookeeper.test.system.GenerateLoad -entry: org.apache.zookeeper.test.system.GenerateLoad \
# 1>out-DTInstr/instr4.out 2>out-DTInstr/instr4.err
