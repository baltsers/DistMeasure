...
MAINCP=".:/home/xqfu/tools/jdk160/jre/lib/rt.jar:/home/xqfu/tools/jdk160/lib/tools.jar:$ROOT/DistEA/DUAForensics.jar:$ROOT/DistEA/DistEA.jar::$ROOT/libs/soot-trunk.jar:$subjectloc/bin"

SOOTCP=".:/home/xqfu/tools/jdk160/jre/lib/rt.jar:$ROOT/DistEA/DistEA.jar:$subjectloc/bin:$subjectloc/build/classes:$subjectloc/build/test/classes:$subjectloc/contrib/fatjar/classes:$subjectloc/lib/netty-3.7.0.Final.jar"
...
/home/xqfu/tools/jdk160/bin/java -Xmx10g -ea -cp ${MAINCP} distEA.distEAInst \
	-w -cp $SOOTCP -p cg verbose:true,implicit-entry:true \
