...
MAINCP=".:/usr/lib/jvm/java-8-openjdk-amd64/jre/lib/rt.jar:$ROOT/libs/DUAForensics.jar:$ROOT/libs/distDIVER.jar:$ROOT/libs/soot-trunk.jar:$subjectloc/conf:$INDIR"
