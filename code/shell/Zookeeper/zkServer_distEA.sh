...
MAINCP=".:/opt/jdk1.8.0_101/jre/lib/rt.jar:$ROOT/DUAForensics.jar:$ROOT/distEADIVER.jar:$ROOT/libs/soot-trunk.jar:$subjectloc/conf:$subjectloc/distEAInstrumented"
