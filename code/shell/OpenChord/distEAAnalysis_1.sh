...
query=${1:-"$subjectloc/methods_1.txt"}
NT=${2:-"1"}
...
MAINCP=".:/usr/lib/jvm/java-8-openjdk-amd64/jre/lib/rt.jar:$ROOT/DUAForensics.jar:$ROOT/DistEA.jar:$ROOT/libs/soot-trunk.jar:$subjectloc/build/classes"
