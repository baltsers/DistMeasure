...
SOOTCP=".:/usr/lib/jvm/java-8-openjdk-amd64/jre/lib/rt.jar:$subjectloc/4119:$subjectloc/java:/home/xqfu/DistTaint/bin"


echo $SOOTCP
OUTDIR=/home/xqfu/netty/DTInstrumented
rm -R $OUTDIR
mkdir -p $OUTDIR
