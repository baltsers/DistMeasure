...
//		System.out.print("i1="+i1);
		...
		String file2="test1/logs/timecost";
    ...
    public static int getMsgCount(String listFile) {  
        ...
        try {  
            ...
            while ((str = br.readLine()) != null) {             	
            	if (str.indexOf(" connected ")>0 || str.startsWith("sentdata = ") || str.startsWith("Server echo: ")) {
            		msgCount++;
            	}
    ...
    public static int getMsgCounts3(String filePrefix, String ith) {  
    	return getMsgCount(filePrefix+"client2DT_"+ith+".log");    	
