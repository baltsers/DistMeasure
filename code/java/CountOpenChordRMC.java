...
public class CountOpenChordRMC {
...
//		int i1=getMsgCounts3("C:/Research/OpenChord/logs/timecostNode","5");
//		System.out.print("i1="+i1);
		String file1="diff0Available.txt";
		String file2="timecostNode";
    ...
    public static int getMsgCount(String listFile) {  
        ...
        try {  
            ...
            while ((str = br.readLine()) != null) {             	
            	if (str.startsWith("oc > ") &&  str.length()>6)
            		msgCount++;
            }  
    ...
    public static int getMsgCounts3(String filePrefix, String ith) {  
    	return getMsgCount(filePrefix+"ADT_"+ith+".log")+getMsgCount(filePrefix+"BDT_"+ith+".log")+getMsgCount(filePrefix+"CDT_"+ith+".log");    	
