...
public class CountQuickServerRMC {
    ...
    public static int getMsgCount(String listFile) {  
        ...
        try {  
            ...
            //     sending closeConnection
            reader = new FileReader(listFile);  	   
            String str = "";  	   
            br = new BufferedReader(reader);

            while ((str = br.readLine()) != null) {             	
            	if (str.indexOf(" sendSystemMsg")>0 || str.indexOf(" closeConnection")>0 || str.indexOf(" sending ")>0) {
            		msgCount++;
            	}
    ...
    public static int getMsgCounts3(String filePrefix, String ith) {  
    	...
    	return getMsgCount(filePrefix+"ServerDT_"+ith+".log")+getMsgCount(filePrefix+"client2DT_"+ith+".log");    	
