...
public class CountZKIntegrationRMC {
...
//		System.out.print("str1="+str1);
		...
		//int i1=getMsgCount("C:/Research/OpenChord/logs/timecostNodeADT_1.log");
//		int i1=getMsgCounts3("C:/Research/z3411/integration_logs/timecost","1");
//		System.out.print("i1="+i1);
    ...
    public static int getMsgCount(String listFile) {  
        ...
        try {  
            ...
            while ((str = br.readLine()) != null) {             	
            	if (str.startsWith("[zk: ") &&  str.indexOf("(CLOSED) ")<0) {
            		msgCount++;
            	}
            	else   if (str.indexOf("Accepted socket connection from ")>0 || str.indexOf("Client attempting to establish new session at ")>0 || str.indexOf("Closed socket connection for client ")>0) {
            		msgCount++;
            	}
    ...
    public static int getMsgCounts3(String filePrefix, String ith) {  
    	return getMsgCount(filePrefix+"Server_"+ith+".log")+getMsgCount(filePrefix+"Client_"+ith+".log");    	
