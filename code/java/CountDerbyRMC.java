...
public class CountDerbyRMC {

	public static void main(String[] args) {
		// TODO Auto-generated method stub
		//int i1=getMsgCount("C:/Research/OpenChord/logs/timecostNodeADT_1.log");
//		int i1=getMsgCounts3("C:/Research/Derby/logs/timecost","2");
//		System.out.print("i1="+i1);
    ...
    public static int getMsgCount(String listFile) {  
        ...
        try {  
            ...
            while ((str = br.readLine()) != null) {             	
            	...
            	else   if (str.indexOf("accept connections on port ")>0 || str.startsWith("ij> ")) {
            		msgCount++;
            	}
    ...
    public static int getMsgCounts3(String filePrefix, String ith) {  
    	return getMsgCount(filePrefix+"serverDT_"+ith+".log")+getMsgCount(filePrefix+"clientDT_"+ith+".log");    	
