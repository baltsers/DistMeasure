...
//		int i1=getMsgCount("C:/Research/z3411/system_logs//timecostSystestDT_1.log");
//		//int i1=getMsgCounts3("C:/Research/z3411/system_logs/timecost","1");
//		System.out.print("i1="+i1);
        ...
        try {  
            ...
            while ((str = br.readLine()) != null) {             	
            	if (str.indexOf("Accepted socket connection from ")>0 || str.indexOf("Client attempting to establish new session at ")>0 
            		...
            		|| str.indexOf("closing socket connection and attempting reconnect")>0 
            			) {
            		msgCount++;
            	}
    ...
    public static int getMsgCounts3(String filePrefix, String ith) {  
    	return getMsgCount(filePrefix+"ServerDT_"+ith+".log")+getMsgCount(filePrefix+"ContainerDT_"+ith+".log")+getMsgCount(filePrefix+"SystestDT_"+ith+".log");    	
